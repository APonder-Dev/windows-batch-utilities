...
mode con: cols=64 lines=44 >nul 2>&1
color 0A
...
cls
echo ============================================================
echo               Windows Batch Utilities  v1.9.0
echo ============================================================
...
echo   6. Ping Sweep              Find alive hosts on the subnet
echo.
echo   FILES
echo   ------------------------------------------------------
echo   7. Smart Backup            Incremental robocopy backup
echo   8. File Organizer          Sort a folder by file type
echo   9. Large File Hunter       Find the biggest space hogs
echo.
echo   DEV
echo   ------------------------------------------------------
echo  10. Git Quick Helper        Stage + commit + push in one go
echo.
echo   OTHER
echo   ------------------------------------------------------
...
if /i "%choice%"=="6" call :run ping_sweep.bat & goto menu
if /i "%choice%"=="7" call :run smart_backup.bat & goto menu
if /i "%choice%"=="8" call :run file_organizer.bat & goto menu
if /i "%choice%"=="9" call :run large_file_hunter.bat & goto menu
if /i "%choice%"=="10" call :run git_quick_helper.bat & goto menu
...
echo.
echo   [X] Invalid option: "%choice%" - choose 1-10, R, L, or X.
timeout /t 2 >nul
goto menu
